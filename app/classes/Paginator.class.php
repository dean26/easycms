...
class Paginator{
	...
	*/
	...
	public function page_links($path='?',$ext=null)
	{
		...
		if ($this->_page > 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$prev"."$ext'><i class=\"fa fa-angle-left\"></i></a></li>";
		else
		...
		if ($this->_page < $counter - 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$next"."$ext'><i class=\"fa fa-angle-right\"></i></a></li>";
		else
		    $pagination.= "<li class='disabled'><a href='#'><i class=\"fa fa-angle-right\"></i></span></li>";
		    $pagination.= "</ul></nav>\n";
		}
