            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td><?php echo e(Page::$status[$rec->status]); ?></td>
                        ...
                        <td colspan="7">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="#" onclick="sendForm('#action_form', <?php echo e("'".AppHelper::UrlTo('/page/delete_many')."'"); ?>); return false;">usuń zaznaczone</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
