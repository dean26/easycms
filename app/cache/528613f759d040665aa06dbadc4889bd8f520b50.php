            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td><b><?php echo e($rec->tytul); ?></b><br/><small>/galeria/<?php echo e($rec->slug); ?></small></td>
                        <td>
                            <?php if($rec->plik): ?>
                                <img src="<?php echo AppHelper::BaseUrl(); ?>public/uploads/galeria/<?php echo $rec->plik; ?>" alt=""/>
                            <?php endif; ?>
                        </td>
                        <td><?php echo e(Galeria::$status[$rec->status]); ?></td>
                        ...
                        <td colspan="7">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="#" onclick="sendForm('#action_form', <?php echo e("'".AppHelper::UrlTo('/galeria/delete_many')."'"); ?>); return false;">usuń zaznaczone</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
