            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td><b>{{ $rec->imie." ".$rec->nazwisko }}</b></td>
                        <td>{{ $rec->login }}</td>
                        <td>{{ User::$typy[$rec->typ] }}</td>
                        <td>{{ User::$status[$rec->status] }}</td>
                        ...
                        <td colspan="7">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="#" onclick="sendForm('#action_form', {{ "'".AppHelper::UrlTo('/user/delete_many')."'"
